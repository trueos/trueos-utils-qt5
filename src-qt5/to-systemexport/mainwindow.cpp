...
qDebug() << "files" << files;
//ExternalProcess::launch("lumina-archiver --aa" << exportFile << files);
...
QString homeDirArchive = QFileDialog::getSaveFileName(this, tr("Where do you want to export your home directory?"), QDir::homePath());
